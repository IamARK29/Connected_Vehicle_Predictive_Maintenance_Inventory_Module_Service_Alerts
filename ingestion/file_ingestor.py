...
TELEMETRY_COL_MAP = {
    ...
    # BMSPackSOH does not exist as a raw TBox signal; kept for legacy data files only
    "BMSPackSOH": "bms_pack_soh",
    "BMSCellMaxVol": "bms_cell_max_vol",
    "BMSCellMinVol": "bms_cell_min_vol",
    # TBox spec uses "Tem" not "Temp" — both aliases kept for backwards compat
    "BMSCellMaxTemp": "bms_cell_max_temp",
    "BMSCellMinTemp": "bms_cell_min_temp",
    "vehBMSCellMaxTem": "bms_cell_max_temp",
    "vehBMSCellMinTem": "bms_cell_min_temp",
    # Real TBox tyre pressure columns (note: frontRrright has double-r per spec)
    "frontLeftTyrePressure":   "tyre_fl",
    "frontRrightTyrePressure": "tyre_fr",
    "rearLeftTyrePressure":    "tyre_rl",
    "rearRightTyrePressure":   "tyre_rr",
    "TyrePressureFL": "tyre_fl",
    "TyrePressureFR": "tyre_fr",
    "TyrePressureRL": "tyre_rl",
    "TyrePressureRR": "tyre_rr",
    # TyreTemp does not exist in TBox — aliases removed
    "GNSSLat": "gnss_lat",
    "GNSSLong": "gnss_long",
    "GNSSAlt": "gnss_alt",
    "GNSSHead": "gnss_head",
