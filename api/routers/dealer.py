...
_PARTS_META: dict[str, dict] = {
    ...
    "OIL-FILTER-MG": {
        "description":      "Oil Filter — MG OEM",
        "unit_cost_inr":    183.0,
        "lead_time_days":   3,
        "abc_class":        "A",
        "supplier":         "MG OEM Direct",
        "service_types":    ["OIL_CHANGE", "FULL_SERVICE"],
        "alert_component":  "engine_oil",
        "replace_km":       7500,
        "per_service_qty":  1,
    ...
    "BR-PAD-F-MG": {
        "description":      "Brake Pads (Front) — MG OEM",
    ...
    "BR-PAD-R-MG": {
        "description":      "Brake Pads (Rear) — MG OEM",
    ...
    "HV-MODULE-MG": {
        "description":      "HV Battery Module — MG ZS EV",
    ...
    "THERMOSTAT-MG": {
        "description":      "Engine Thermostat — MG OEM",
...
def _compute_demand_forecast(dealer_code: str) -> list[dict]:
    ...
    avg_km_per_month = 1500  # typical MG India monthly mileage
